...
{
    TYPE Sx, Sy, Sz, SO,DO,costheta,sintheta,DecWidth,DecHeigh,dYL,dZL,YCenter,ZCenter;//,ObjR;
	int  YL, ZL;
	TYPE *ProjSlice;
    const TYPE *Coef;
    ...
    //                         'Det', [YL ZL DecWidsth DecHeigh YC ZC]);
