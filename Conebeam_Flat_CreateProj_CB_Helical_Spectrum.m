function [ScPos Proj] = Conebeam_Flat_CreateProj_CB_Helical_Spectrum(ScanGeom,Energy)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
YL = ScanGeom.ScDet(3);              
ZL = ScanGeom.ScDet(4);              
DecWidth = ScanGeom.ScDet(5)/ObjR;  % Normalized detector array width
...
for En = 1: EnNum
    ...
    %EnAttenuationCoef = EnAttenuationCoef*0+1;
    ...
    for ProjIndex=1:ViewN
         ...
         SliceProjGeom = struct( 'Sc',  [Sx Sy Sz SO DO costheta sintheta],  ...
                                 'Det', [YL ZL DecWidth DecHeigh YLC ZLC]);
